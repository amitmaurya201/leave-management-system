...
import com.adjecti.leave.exception.NoSuchEmployeeException;
import com.adjecti.leave.model.Employee;
import com.adjecti.leave.model.impl.EmployeeImpl;
import com.adjecti.leave.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl
	...
	public Employee[] findByemployeeName_PrevAndNext(
		...
		try {
			...
			array[0] = getByemployeeName_PrevAndNext(
				session, employee, employeeName, orderByComparator, true);

			array[1] = employee;

			array[2] = getByemployeeName_PrevAndNext(
				session, employee, employeeName, orderByComparator, false);
	...
	protected Employee getByemployeeName_PrevAndNext(
		Session session, Employee employee, String employeeName,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_EMPLOYEENAME_EMPLOYEENAME_3 =
		"(employee.employeeName IS NULL OR employee.employeeName = '')";
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByemployeeName = _createFinderPath(
		...
		_finderPathWithoutPaginationFindByemployeeName = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByemployeeName",
			new String[] {String.class.getName()},
			new String[] {"employeeName"}, true);

		_finderPathCountByemployeeName = _createFinderPath(
